...
The Habitat night ritual. Four hops, one clock.

## User-invoked

Reachable only when you type them.

- **[ask-bunny](./ask-bunny/SKILL.md)**: Ask which skill or flow fits. A router over the skills in this repo.
- **[start-sprint](./start-sprint/SKILL.md)**: Run a timeboxed ship sprint: lock, build, ship, roast.
- **[setup-habitat](./setup-habitat/SKILL.md)**: Write the burrow and set how this repo sprints. Run once per repo.
